...
object FinalExam {
  def main(args: Array[String]): Unit = {
    ...
    selloutDataFromOracle.createOrReplaceTempView("keydata") //selloutDataFromOracle을 "keydata"라는 이름으로 view테이블로 변경
    ...
    var finalResult = spark.sql("select  REGIONID, PRODUCT, SUBSTR(YEARWEEK,5,6) AS WEEK, " +
